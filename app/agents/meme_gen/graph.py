...
class MemeGenGraph:
    ...
    def _validator_condition(self, state: MemeGenState) -> str:
        primary_status = state.trend_research_validation.primary_topic_validation_status
        secondary_status = state.trend_research_validation.secondary_topic_validation_status
    ...
    async def build(self):
        ...
        builder.add_edge(MemeGenTrendResearcher.NODE_NAME, MemeGenTrendValidator.NODE_NAME)

...
class TestMemeGenTrendResearcher:
    ...
    async def test_run(self, node: MemeGenTrendResearcher, mocks: Dict[Type[Any], Any]):
        ...
        # Assert
        assert final_state.trend_research is not None
        assert final_state.trend_research.primary_topic == "birthday party" or final_state.trend_research.primary_topic == "mountain hike"
